package com.gallery.camera.fragment;
...
import com.gallery.camera.activity.BaseActivity;
import com.gallery.camera.activity.MainActivity;
...
public class BaseFragment extends Fragment implements BaseActivity.ActivityListener {
    ...
    protected class PrivacyLockerAdapter extends RecyclerView.Adapter<PrivacyLockerAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ViewHolder holder = new ViewHolder(LayoutInflater.from(getActivity()).inflate(
